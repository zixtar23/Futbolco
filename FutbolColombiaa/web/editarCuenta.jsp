...
<html>
    <head>
        ...
        <meta http-equiv="refresh" content="1;URL=editarCuenta.jsp">
        <% }%>
    </head>
    <body>
        <header>
                            ...
                            <%
                                ...
                                if (sesion.getAttribute("usuario") != null && sesion.getAttribute("nivel") != null) {
                                    ...
                                    if (nivel == 1) {
                                        ...
                                        out.print("<li><a class='active'><h5>Usuario " + usuario + "</h5></a>");
                                        out.print("<ul>");
                                        out.print("<li><a href='editarCuenta.jsp' class='active1'><h5>Editar cuenta</h5></a></li>");
            ...
            <div class="contenido">
                <form ACTION="ServletUsuario" METHOD="POST">
                    <%
                        ...
                        List<usuarios> y = dao.consultarUsuarioId(id);
                        for (usuarios usu : y) {
                    %> 
                    <a>Usuario:</a><br><br>
                    <a ><h1><%=usu.getUsuario()%></h1></a><br>
                    <a>Correo:</a><br>
                    <input type="text" name="correo" value="<%=usu.getCorreo()%>"> <br>
                    <input type="hidden" name="id" value="<%=usu.getId_usuario()%>"> 
                    <a>Ciudad:</a><br>
                    <input type="text" name="ciudad" value="<%=usu.getCiudad()%>"> 
